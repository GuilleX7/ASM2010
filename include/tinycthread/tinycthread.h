...
* @param res If this pointer is not 0, the function will store the result
...
* @param remaining If non-0, this parameter will hold the remaining
...
*        successful.
* @param dtor Destructor function. This can be 0.
* @return @ref thrd_success on success, or @ref thrd_error if the request could
* not be honored.
