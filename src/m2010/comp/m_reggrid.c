...
m_comp_reggrid_reg const regs[M_COMP_REGGRID_LENGTH] = {
    [M_COMP_REGGRID_R0] = {.name = "R0", .format = HEX8_X_FORMAT},
    [M_COMP_REGGRID_R1] = {.name = "R1", .format = HEX8_X_FORMAT},
    [M_COMP_REGGRID_R2] = {.name = "R2", .format = HEX8_X_FORMAT},
    [M_COMP_REGGRID_R3] = {.name = "R3", .format = HEX8_X_FORMAT},
    [M_COMP_REGGRID_R4] = {.name = "R4", .format = HEX8_X_FORMAT},
    [M_COMP_REGGRID_R5] = {.name = "R5", .format = HEX8_X_FORMAT},
    [M_COMP_REGGRID_R6] = {.name = "R6", .format = HEX8_X_FORMAT},
    [M_COMP_REGGRID_R7] = {.name = "R7", .format = HEX8_X_FORMAT},
    [M_COMP_REGGRID_PC] = {.name = "PC", .format = HEX8_X_FORMAT},
    [M_COMP_REGGRID_SP] = {.name = "SP", .format = HEX8_X_FORMAT},
    [M_COMP_REGGRID_IR] = {.name = "IR", .format = HEX16_X_FORMAT},
    [M_COMP_REGGRID_AC] = {.name = "AC", .format = HEX8_X_FORMAT},
    ...
    [M_COMP_REGGRID_MDR] = {.name = "MDR", .format = HEX8_X_FORMAT},
    [M_COMP_REGGRID_MAR] = {.name = "MAR", .format = HEX8_X_FORMAT},
};
