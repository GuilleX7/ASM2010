...
/**
    ...
    @param key Pointer to the string that will be used as the entry
            key (will be copied)
...
static size_t const hash_sizes[] = {53,       101,      211,      503,       1553,      3407,      6803,      12503,
                                    25013,    50261,    104729,   250007,    500009,    1000003,   2000029,   4000037,
                                    10000019, 25000009, 50000047, 104395301, 217645177, 512927357, 1000000007};
